...
* [Kong - Management Layer for Microservices and APIs](https://github.com/kong/kong) ⭐ 44,052 | 🐛 191 | 🌐 Lua | 📅 2026-08-16
...
* [nginx-lua - Nginx 1.19+ with LUA support based on Alpine Linux, Amazon Linux, CentOS, Debian, Fedora and Ubuntu.](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 6 | 🌐 Dockerfile | 📅 2026-08-28
...
* [Difference between OpenResty and Tengine](https://github.com/openresty/openresty/issues/54) ⭐ 14,016 | 🐛 333 | 🌐 C | 📅 2026-08-24
