# Awesome Nginx Resources with stars
...
* [Nginx Optimization: understanding sendfile, tcp\_nodelay and tcp\_nopush](https://fv.gs/nginx-optimization-understanding-sendfile-tcp-nodelay-and-tcp-nopush-c55cdd276765)
...
* [Nginx HTTP server boilerplate configs](https://github.com/h5bp/server-configs-nginx) ⭐ 11,560 | 🐛 1 | 📅 2026-06-20
* [Gixy - Nginx configuration static analyzer](https://github.com/yandex/gixy) ⭐ 8,566 | 🐛 60 | 🌐 Python | 📅 2024-07-28 - Maintained forks: [gixy-ng](https://github.com/dvershinin/gixy) ⭐ 1,183 | 🐛 0 | 🌐 Python | 📅 2026-09-02, [gixy-next](https://github.com/MegaManSec/Gixy-Next) ⭐ 188 | 🐛 19 | 🌐 Python | 📅 2026-08-15
* [Nginx Boilerplate - Configuration template and a set of handy must-have snippets](https://github.com/nginx-boilerplate/nginx-boilerplate) ⭐ 2,436 | 🐛 1 | 🌐 Dockerfile | 📅 2018-07-26
...
* [Kong - Management Layer for Microservices and APIs](https://github.com/kong/kong) ⭐ 44,096 | 🐛 194 | 🌐 Lua | 📅 2026-09-07
...
* [nginx-lua - Nginx 1.19+ with LUA support based on Alpine Linux, Amazon Linux, CentOS, Debian, Fedora and Ubuntu.](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 12 | 🌐 Dockerfile | 📅 2026-09-08
...
* [Collection of njs use cases](https://github.com/f5devcentral/nginx-njs-usecases) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2023-10-04
...
* [Difference between OpenResty and Tengine](https://github.com/openresty/openresty/issues/54) ⭐ 14,028 | 🐛 335 | 🌐 C | 📅 2026-09-02
