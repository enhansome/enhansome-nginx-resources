...
* [Kong - Management Layer for Microservices and APIs](https://github.com/kong/kong) ⭐ 44,080 | 🐛 194 | 🌐 Lua | 📅 2026-09-03
...
* [nginx-lua - Nginx 1.19+ with LUA support based on Alpine Linux, Amazon Linux, CentOS, Debian, Fedora and Ubuntu.](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 7 | 🌐 Dockerfile | 📅 2026-09-03
...
* [Difference between OpenResty and Tengine](https://github.com/openresty/openresty/issues/54) ⭐ 14,024 | 🐛 333 | 🌐 C | 📅 2026-09-02
